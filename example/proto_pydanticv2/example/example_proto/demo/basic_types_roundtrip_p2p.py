...
class BasicTypesMessage(MyBaseSchema):
    ...
    fixed32_field: float = Field(default=0.0)
    fixed64_field: float = Field(default=0.0)
    sfixed32_field: float = Field(default=0.0)
    sfixed64_field: float = Field(default=0.0)
    ...
    repeated_fixed32: typing.List[float] = Field(default_factory=list)
    repeated_fixed64: typing.List[float] = Field(default_factory=list)
    repeated_sfixed32: typing.List[float] = Field(default_factory=list)
    repeated_sfixed64: typing.List[float] = Field(default_factory=list)
