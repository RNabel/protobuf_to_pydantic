...
class OneofRules(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["optional", b"optional"]) -> None: ...
...
class FieldRules(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_message", b"_message", "any", b"any", "bool", b"bool", "bytes", b"bytes", "double", b"double", "duration", b"duration", "enum", b"enum", "fixed32", b"fixed32", "fixed64", b"fixed64", "float", b"float", "int32", b"int32", "int64", b"int64", "map", b"map", "message", b"message", "repeated", b"repeated", "sfixed32", b"sfixed32", "sfixed64", b"sfixed64", "sint32", b"sint32", "sint64", b"sint64", "string", b"string", "timestamp", b"timestamp", "type", b"type", "uint32", b"uint32", "uint64", b"uint64"]) -> None: ...
    @typing.overload
...
class FloatRules(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_const", b"_const"]) -> typing.Literal["const"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_description", b"_description"]) -> typing.Literal["description"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_enable", b"_enable"]) -> typing.Literal["enable"] | None: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_ge", b"_ge"]) -> typing.Literal["ge"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_gt", b"_gt"]) -> typing.Literal["gt"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_le", b"_le"]) -> typing.Literal["le"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_lt", b"_lt"]) -> typing.Literal["lt"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_multiple_of", b"_multiple_of"]) -> typing.Literal["multiple_of"] | None: ...
    @typing.overload
...
class BoolRules(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing.Literal["_enable", b"_enable"]) -> typing.Literal["enable"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_example", b"_example"]) -> typing.Literal["example"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_extra", b"_extra"]) -> typing.Literal["extra"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_field", b"_field"]) -> typing.Literal["field"] | None: ...
...
class StringRules(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing.Literal["_field", b"_field"]) -> typing.Literal["field"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_len", b"_len"]) -> typing.Literal["len"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_max_length", b"_max_length"]) -> typing.Literal["max_length"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_min_length", b"_min_length"]) -> typing.Literal["min_length"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_not_contains", b"_not_contains"]) -> typing.Literal["not_contains"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_pattern", b"_pattern"]) -> typing.Literal["pattern"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_prefix", b"_prefix"]) -> typing.Literal["prefix"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_suffix", b"_suffix"]) -> typing.Literal["suffix"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_title", b"_title"]) -> typing.Literal["title"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_type", b"_type"]) -> typing.Literal["type"] | None: ...
    ...
    def WhichOneof(self, oneof_group: typing.Literal["example_config", b"example_config"]) -> typing.Literal["example", "example_factory"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["well_known", b"well_known"]) -> typing.Literal["email", "hostname", "ip", "ipv4", "ipv6", "uri", "uri_ref", "address", "uuid", "pydantic_type"] | None: ...
...
class RepeatedRules(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing.Literal["_field", b"_field"]) -> typing.Literal["field"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_items", b"_items"]) -> typing.Literal["items"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_max_items", b"_max_items"]) -> typing.Literal["max_items"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_min_items", b"_min_items"]) -> typing.Literal["min_items"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_title", b"_title"]) -> typing.Literal["title"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_type", b"_type"]) -> typing.Literal["type"] | None: ...
...
class MapRules(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing.Literal["_field", b"_field"]) -> typing.Literal["field"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_keys", b"_keys"]) -> typing.Literal["keys"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_max_pairs", b"_max_pairs"]) -> typing.Literal["max_pairs"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_min_pairs", b"_min_pairs"]) -> typing.Literal["min_pairs"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_title", b"_title"]) -> typing.Literal["title"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_type", b"_type"]) -> typing.Literal["type"] | None: ...
...
class TimestampRules(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing.Literal["_gt", b"_gt"]) -> typing.Literal["gt"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_gt_now", b"_gt_now"]) -> typing.Literal["gt_now"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_le", b"_le"]) -> typing.Literal["le"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_lt", b"_lt"]) -> typing.Literal["lt"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_lt_now", b"_lt_now"]) -> typing.Literal["lt_now"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_title", b"_title"]) -> typing.Literal["title"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_type", b"_type"]) -> typing.Literal["type"] | None: ...
