...
class TestOneofFieldTypes:
    ...
    def test_oneof_with_well_known_types(self):
        ...
        assert isinstance(report_time.data.time_value, Timestamp)
        
        # Can access timestamp methods
        dt = report_time.data.time_value.ToDatetime()
    ...
    def test_oneof_with_map_fields(self):
        ...
        msg = OptionalMessage(
            y=42,
            int_map={"key1": 100, "key2": 200, "key3": 300}
        )
    ...
    def test_oneof_field_type_validation(self):
        ...
        # Note: The generated models use Any type for message fields,
        # so these don't raise validation errors as expected
        report1 = ReportData(location_value="not_a_geo_location")
        assert report1.data.location_value == "not_a_geo_location"
        
        report2 = ReportData(time_value="not_a_timestamp")
        assert report2.data.time_value == "not_a_timestamp"
