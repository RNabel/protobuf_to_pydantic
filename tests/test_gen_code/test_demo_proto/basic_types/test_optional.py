...
class TestOptionalFields(RoundTripTestBase):
    ...
    @pytest.mark.skip(reason="Fails due to incorrect one_of handling")
    @pytest.mark.oneof_handling
    def test_optional_message_field(self):
        ...
        self.verify_roundtrip(proto_msg, demo_p2p.OptionalMessage)
        ...
        self.verify_roundtrip(proto_msg_unset, demo_p2p.OptionalMessage)
