...
class TestWellKnownTypesRoundTrip(RoundTripTestBase):
    ...
    def test_timestamp_roundtrip(self):
        ...
        self.verify_roundtrip(proto_msg, well_known_types_roundtrip_p2p.WellKnownTypesMessage)
    ...
    def test_complex_well_known_types_message(self):
        ...
        # Set multiple fields
        proto_msg.created_at.FromDatetime(datetime(2024, 1, 1, 12, 0, 0, tzinfo=timezone.utc))
    ...
    def test_repeated_timestamps(self):
        ...
        self.verify_roundtrip(proto_msg, well_known_types_roundtrip_p2p.RepeatedWellKnownTypes)
    ...
    def test_map_with_value_type(self):
        ...
        # Add a struct value
        proto_msg.value_map["struct_key"].struct_value.fields["nested"].string_value = "nested value"
