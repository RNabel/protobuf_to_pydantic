...
def python_value_to_protobuf_value(python_value: Any, proto_value: struct_pb2.Value) -> None:
    ...
    if python_value is None:
        ...
        for key, value in python_value.items():
            python_value_to_protobuf_value(value, proto_value.struct_value.fields[key])
        ...
        for item in python_value:
            ...
            python_value_to_protobuf_value(item, list_item)
    else:
        # Fallback: convert to string for unsupported types
        proto_value.string_value = str(python_value)
...
def protobuf_value_to_python_value(proto_value: struct_pb2.Value) -> Any:
    ...
    if which == "null_value":
        ...
        return {
            key: protobuf_value_to_python_value(value)
